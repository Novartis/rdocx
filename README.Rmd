...
For quick access to the documentation, visit [ADD LINK TO PAGES IN GITHUB]. Read the vignettes on how to use the package with step-by-step examples online:
